...
**Staff can't see expected patients after switching sites.**
- Multi-facility users must **switch to the correct facility** before opening the
  roster or clinical records. **`warden`** users see operational metrics only — not
  clinical PHI.
