...
- **Roles:** `pt`, `admin`, `warden`, `it_admin` — granted only by admin; **facility-scoped** via RLS
- **Multi-facility:** staff may switch facilities; data isolated per facility membership
...
access**). Application logs exclude PHI.
