...
## Other programs on the portal

When licensed and feature-flagged for the facility, patients may also access:

- **[Medical intake](/veridian-motion/medical-intake)** — one-time medical profile
- **[Precision Rehab](/veridian-motion/precision-rehab)** — course, guided self-treatment, daily routines
- **[Chess Wellness](/veridian-motion/chess-wellness)** — play, puzzles, academy (offline engine)

At registration, patients accept **[versioned Terms](/veridian-motion/legal-terms)**.
