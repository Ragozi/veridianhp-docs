...
After **Terms acceptance** at first login, and when licensed/feature-flagged,
patients may access:
...
- **[Precision Rehab](/veridian-motion/precision-rehab)** — course, guided self-treatment, Daily Movement
- **[Chess Wellness](/veridian-motion/chess-wellness)** — play, puzzles, academy (offline engine)
